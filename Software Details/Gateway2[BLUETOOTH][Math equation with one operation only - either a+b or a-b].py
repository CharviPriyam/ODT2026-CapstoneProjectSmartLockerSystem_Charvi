#Gateway 2 (math equation) bluetooth at the end with either a+b or a-b type equations [1 operation]
...
#========================================================================================================================
    #NEW: GATEWAY 2 [My part]
        ...
        target_distance = random.randint(10, 15)           #for example,lets say 12
        ...
        if operation == '+':
            num1 = random.randint(1, target_distance - 1)     #if 12: (1,11), lets assume num1 is then 9
            num2 = target_distance - num1                     #12-9=3, hence, num2 is 3
            equation_str = str(num1) + " + " + str(num2) + " = ?"    #9+3=? (12!)
        else: #Subtraction
            num2 = random.randint(1, 10) #Random number to subtract   #num2 = lets say, 5
            num1 = target_distance + num2                             #num1 = 12+5 = 17
            equation_str = str(num1) + " - " + str(num2) + " = ?"     #17-5=? (12!)
